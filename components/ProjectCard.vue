      ...
      <div class="p-6">
        <div class="flex flex-row justify-between items-center">
          ...
          <div class="flex flex-row justify-between">
            <div class="mx-1">
              <a class="text-sm text-gray-700 transition hover:text-gray-600" target="_blank" rel="noopener noreferrer" :href="projectHref">
                <span class="sr-only"></span>
                <img class="w-6 h-6" src="~assets/icon/external.svg"/>
              </a>
            </div>
            <div class="mx-1">
              <a class="text-sm text-gray-500 transition hover:text-gray-600" target="_blank" rel="noopener noreferrer" :href="projectGithub">
